...
ENTITY vga IS
PORT(CLK: IN STD_LOGIC; -- RELOJ DE 25 MHz (PLL)
    RST: IN STD_LOGIC;
	  HSYNC, VSYNC: OUT STD_LOGIC; -- SINCRONIZACION HORIZONTAL Y VERTICAL
	  R, G, B: OUT STD_LOGIC_VECTOR(3 DOWNTO 0)); -- SALIDAS RGB
END vga_mov;
